          ...
          <div className={styles.footerDesktop}>
            <div className="row">
              ...
              <div className="col-lg-2 col-md-6 col-6 mb-4 mb-lg-0">
                <h5 className={styles.columnTitle}>Calculators</h5>
                <ul className={styles.footerLinks}>
                  <li><Link href="/">Gratuity Calculator</Link></li>
                  <li><Link href="/mohre-calculator">MOHRE Calculator</Link></li>
                  <li><Link href="/mohre-gratuity-calculator">MOHRE Gratuity</Link></li>
                  <li><Link href="/unlimited-contract">Unlimited Contract</Link></li>
                  <li><Link href="/limited-contract">Limited Contract</Link></li>
                </ul>
              </div>

              {/* Emirates Column */}
              <div className="col-lg-2 col-md-6 col-6 mb-4 mb-lg-0">
                <h5 className={styles.columnTitle}>Emirates</h5>
                <ul className={styles.footerLinks}>
                  {Object.entries(UAE_EMIRATES).map(([key, emirate]) => (
                    <li key={key}>
                      <Link href={`/${emirate.slug}`}>{emirate.name}</Link>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              {/* Free Zones Column */}
              <div className="col-lg-2 col-md-6 col-6 mb-4 mb-lg-0">
                <h5 className={styles.columnTitle}>Free Zones</h5>
                <ul className={styles.footerLinks}>
                  {POPULAR_FREE_ZONES.map((zone) => (
                    <li key={zone.slug}>
                      <Link href={zone.slug}>{zone.name}</Link>
                    </li>
                  ))}
                  <li><Link href="/free-zones" className={styles.viewAll}>All Free Zones</Link></li>
                </ul>
              </div>
            ...
            <div className={styles.mobileAccordions}>
              ...
              <div className={styles.mobileAccordion}>
                ...
                <div className={`${styles.accordionContent} ${mobileAccordion === 'calculators' ? styles.accordionContentOpen : ''}`}>
                  <Link href="/">Gratuity Calculator</Link>
                  <Link href="/mohre-calculator">MOHRE Calculator</Link>
                  <Link href="/unlimited-contract">Unlimited Contract</Link>
                  <Link href="/limited-contract">Limited Contract</Link>
                </div>
              </div>
              ...
              <div className={styles.mobileAccordion}>
                ...
                <div className={`${styles.accordionContent} ${mobileAccordion === 'emirates' ? styles.accordionContentOpen : ''}`}>
                  {Object.entries(UAE_EMIRATES).map(([key, emirate]) => (
                    <Link key={key} href={`/${emirate.slug}`}>{emirate.name}</Link>
                  ))}
                </div>
              </div>
